...
class AdminProvider with ChangeNotifier {
  ...
  // API Helper
  String _getUrl(String endpoint) => AuthProvider.getBaseUrl('admin/$endpoint');
  ...
  Future<bool> broadcastAnnouncement(String title, String message, String target) async {
    try {
