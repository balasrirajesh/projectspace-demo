  ...
  Future<void> _initClassroom() async {
    ...
    _classroomService.onChatMessage = (from, message) {
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).clearSnackBars(); // Clear existing to show immediate new ones
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            margin: const EdgeInsets.fromLTRB(16, 16, 16, 100), // Position above the controls
