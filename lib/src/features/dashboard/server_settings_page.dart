...
import 'package:alumini_screen/src/shared/services/network_discovery_service.dart';
...
class _ServerSettingsPageState extends State<ServerSettingsPage> {
      ...
      if (mounted) {
        ...
        if (discovered.isEmpty) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('No servers found on network. Ensure server is running on port 3000.')),
          );
        }
      }
    } catch (e) {
  ...
  Future<void> _clearSavedIp() async {
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('✅ Saved IP cleared, using auto-detected')),
      );
    }
  }
      ...
      body: ListView(
        ...
        children: [
          ...
          ElevatedButton.icon(
            ...
            label: Text(_scanning ? 'Scanning Network...' : 'Scan Network for Server'),
