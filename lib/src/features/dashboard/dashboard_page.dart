...
import 'package:alumini_screen/src/features/mentorship/broadcast_streaming_page.dart';
import 'package:alumini_screen/src/features/dashboard/server_settings_page.dart';
    ...
    return SliverAppBar(
      ...
      actions: [
        IconButton(
          ...
          onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const ServerSettingsPage())),
        ),
          ...
          child: Row(
            ...
            children: [
              Expanded(child: _buildStatCard(context, "Mentees Guided", "12", Icons.people_outline, Colors.blue, 
                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const MenteesPage(initialShowActive: false))))),
              const SizedBox(width: 16),
              Expanded(child: _buildStatCard(context, "Sessions Held", "45", Icons.event_available_outlined, Colors.green,
                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const SessionsPage())))),
            ],
          ),
        ),
        const SizedBox(height: 16),
              ...
              Selector<MentorshipProvider, int>(
                ...
                builder: (context, count, _) => 
                  Expanded(child: _buildStatCard(context, "Active Mentees", count.toString(), Icons.school_outlined, Colors.orange,
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const MenteesPage())))),
              ),
              const SizedBox(width: 16),
              Expanded(child: _buildStatCard(context, "Unresolved Queries", "3", Icons.question_answer_outlined, Colors.purple,
                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const NotificationsPage())))), // Unresolved queries are alerts for now
            ],
          ),
        ),
      ],
