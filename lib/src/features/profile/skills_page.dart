...
class SkillsPage extends StatelessWidget {
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildSkillCategory("Technical Skills", skills, Icons.code_rounded, const Color(0xFFE8F5E9), const Color(0xFF2E7D32)),
                const SizedBox(height: 16),
                _buildSkillCategory("Soft Skills", ["Mentorship", "Public Speaking", "Team Lead"], Icons.people_outline_rounded, const Color(0xFFE3F2FD), const Color(0xFF1976D2)),
                const SizedBox(height: 24),
                _buildInfoCard("These topics help students find you for specific mentorship needs."),
              ],
            ),
          ),
        );
  ...
  Widget _buildSkillCategory(String title, List<String> skills, IconData icon, Color bgColor, Color textColor) {
    return Container(
