      ...
      body: ListView(
        ...
        children: [
          _buildBadgeCategory("Platform Status", [
            _buildBadgeCard("Top Mentor", "Top 5% active mentors", Icons.verified_user_rounded, Colors.blue),
            _buildBadgeCard("Fast Responder", "Avg response < 2hrs", Icons.bolt_rounded, Colors.amber),
          ]),
          const SizedBox(height: 32),
          _buildBadgeCategory("Experience", [
            _buildBadgeCard("10+ Sessions", "Completed mentorships", Icons.groups_rounded, Colors.green),
            _buildBadgeCard("Topic Expert", "Highly rated in Flutter", Icons.psychology_outlined, Colors.purple),
          ]),
        ],
      ),
    );
