      ...
      child: IntrinsicHeight(
        child: Row(
          ...
          children: [
            ...
            _buildStatItem(
                auth.status == UserStatus.verified ? "Verified" : "Pending",
                "Status",
                Icons.verified_outlined,
                Colors.blue),
            const VerticalDivider(width: 1),
            _buildStatItem(auth.yoe.isNotEmpty ? auth.yoe : "0", "Years",
                Icons.history_edu_rounded, Colors.green),
          ],
        ),
      ),
    );
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: skills
                .map((skill) => _buildSkillChip(skill, bgColor, textColor))
                .toList(),
          ),
        ],
      ),
