    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _buildInfoCard(
                "Set your weekly availability for student mentorship calls."),
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    subtitle: Text(
                        isEnabled ? "9:00 AM - 5:00 PM" : "Not Available",
                        style: TextStyle(
                            fontSize: 12,
      ...
      child: Row(
        children: [
          const Icon(Icons.calendar_month_outlined,
              color: Color(0xFFF06292), size: 20),
          const SizedBox(width: 12),
          Expanded(
            child: Text(text,
                style: const TextStyle(fontSize: 13, color: Color(0xFFF06292))),
          ),
        ],
      ),
    );
