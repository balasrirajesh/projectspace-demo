...
class SkillPackageScreen extends StatefulWidget {
  const SkillPackageScreen({super.key});

  @override
  State<SkillPackageScreen> createState() => _SkillPackageScreenState();
}

class _SkillPackageScreenState extends State<SkillPackageScreen> {
  String _selectedBranch = 'CSE';

  @override
  Widget build(BuildContext context) {
    final data = skillPackageData[_selectedBranch] ?? skillPackageData['CSE']!;
                          ...
                          BarChartData(
                            ...
                            barGroups: data.asMap().entries.map((e) {
                              ...
                              return BarChartGroupData(
                                ...
                                barRods: [
                                  BarChartRodData(
                                    toY: (d['maxPkg'] as double),
                                    fromY: (d['minPkg'] as double),
                                    width: 18,
                ...
                sliver: SliverList(
                  delegate: SliverChildBuilderDelegate(
                    (context, i) {
                      ...
                      final min = d['minPkg'] as double;
                      final max = d['maxPkg'] as double;
